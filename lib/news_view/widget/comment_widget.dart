  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            color: const Color(0xffDFDFDF),borderRadius: BorderRadius.circular(15)
          ...
          child: Column(
            ...
            children: [
              Text(user?.name??"",style: FontsManger.largeFont(context)?.copyWith(fontSize: 12,color: const Color(0xff343434)),),
              const SizedBox(height: 5,),
              Text(widget.comment.comment,style: FontsManger.largeFont(context)?.copyWith(fontSize:13,color: Colors.black ),)
            ],
          )
        )
      ],
