    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(child: SvgPicture.asset(
                        "assets/image/Notification---3.svg", width: 10,
                        height: 30,
                        fit: BoxFit.cover,),
                          onTap: () => navigatorWid(page: const NewsScreen(),
                              returnPage: true,
                              context: context)),
                      ...
                      InkWell(child: SvgPicture.asset(
                        "assets/image/Message---4.svg", width: 10,
                        height: 30,
                        fit: BoxFit.cover,),
                        onTap: () =>
                        context.appCuibt.isVisitor ? navigatorWid(
            ...
            imageBuilder: (context, i) =>
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color(0xffE1E1E1), width: 6)
                  ),
                ),
            errorWidget: (context, i, _) =>
                Container(
                  height: 135,
                  width: 135,
                  decoration: BoxDecoration(
          ...
          Center(child: Text(context.appCuibt.user?.name ?? "",
            style: FontsManger.largeFont(context)?.copyWith(
                color: ColorsManger.pColor),)),
          Center(child: Text(" الفرقه ${context.appCuibt.user?.team ?? 0}",
            style: FontsManger.mediumFont(context)?.copyWith(
                color: ColorsManger.text3.withOpacity(.4)),)),
          Center(
            child: Container(
              height: 32,
            ...
            child: Align(
                ...
                child: InkWell(
                    onTap: () {
                      ...
                      MotionToast.success(
                          description: const Text("تم النسخ بنجاح ")).show(
                          context);
                    },
                    child: Text("أضغط لنسخ الكود",
                      style: FontsManger.mediumFont(context)?.copyWith(
          ...
          ListTile(
            ...
            context.appCuibt.isVisitor ? navigatorWid(
                ...
                returnPage: false)
                : navigatorWid(
                page: const EditUser(), returnPage: true, context: context),
          ...
          ListTile(
            ...
            context.appCuibt.isVisitor ? navigatorWid(
                ...
                ? navigatorWid(page: PdfView(
                pdfLink: context.appCuibt.collage!.studySchedules),
                returnPage: true,
                context: context)
                : MotionToast.error(
                description: const Text("يوجد مشكله ف عرض هذا الملف")).show(
                context),
            leading: Image.asset(
                "assets/image/homework.png", width: 20, height: 20),
          ...
          ListTile(
            ...
            context.appCuibt.isVisitor ? navigatorWid(
                ...
                context: context,
                returnPage: false)
                : context.appCuibt.collage?.courseDates != null ? navigatorWid(
                page: PdfView(pdfLink: context.appCuibt.collage!.courseDates),
                returnPage: true,
                context: context) : MotionToast.error(
                description: const Text("يوجد مشكله ف عرض هذا الملف")).show(
                context),
