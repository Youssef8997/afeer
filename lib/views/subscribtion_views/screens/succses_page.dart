...
class _SuccsesPageState extends State<SuccsesPage> {
  ...
  void initState() {
    context.appCuibt
        .addSubscribeTUser(widget.sub, context.appCuibt.user!, context);
    super.initState();
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "لقد اتتمت اشتراكك بنجاح",
                  style: FontsManger.largeFont(context)?.copyWith(fontSize: 23),
                ),
                const SizedBox(
                  height: 20,
                ),
                ...
                ElevatedButton(
                    onPressed: () {
                      ...
                      context.appCuibt.addSubscribeTUser(
                          widget.sub, context.appCuibt.user!, context);
                      navigatorWid(
                          page: HomeScreen(),
                          returnPage: false,
                          context: context);
