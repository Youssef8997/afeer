...
import 'package:afeer/views/lecture_views/screens/show_exam_screen.dart';
...
import 'sent_q_call_screen.dart';
                    ...
                    children: [
                      ...
                      if (isVideo && widget.lecture.videoLink != null)
                        InkWell(
                          onTap: () => navigatorWid(
                              page: VideoScreen(
                                videoId: widget.lecture.videoLink!["link"],
                          ...
                          children: [
                            Container(
                              ...
                              child: SizedBox(
                                  ...
                                  height: 10,
                                  child: Image.asset(
                                      "assets/image/question-mark.png",
                                      width: 10,
                                      height: 10,
                                      fit: BoxFit.cover)),
                            ),
