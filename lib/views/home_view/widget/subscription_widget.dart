...
class SubscriptionWidget extends StatefulWidget {
  ...
  const SubscriptionWidget(
      {super.key, required this.name, required this.disc, required this.price});
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Divider(
                      ...
                      endIndent: context.width * .12),
                  SizedBox(
                      width: context.width * .7,
                      child: Text(
                        widget.disc,
                        style: FontsManger.mediumFont(context)
                            ?.copyWith(fontSize: 12, color: ColorsManger.text3),
                      )),
                ],
              ),
            ),
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Text("اشترك الآن ${widget.price} ج.م",
                    style: FontsManger.largeFont(context)
