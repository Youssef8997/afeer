import 'package:afeer/lecture_views/screens/sent_q_call_screen.dart';
import 'package:afeer/lecture_views/screens/show_exam_screen.dart';
...
if(isPdf)
    ...
    InkWell(
      onTap: ()=>navigatorWid(page: const SentQCallScreen(),returnPage: true,context: context,),
      child: Row(
        children: [
          Container(
