...
class LectureAddScreens extends StatefulWidget {
  ...
  const LectureAddScreens({super.key, required this.subjectName,});
                ...
                if(context.appCuibt.lectureAdditionalList.isNotEmpty)
                  SizedBox(
                      ...
                      child: ListView.separated(itemBuilder: (context,i)=>ListTile(
                        onTap: ()=>navigatorWid(page: LectureDetAddScreen(subjectName: widget.subjectName,lecture:context.appCuibt.lectureAdditionalList[i] ),context: context,returnPage: true),
