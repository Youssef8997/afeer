...
class LectureDetAddScreen extends StatefulWidget {
  final String subjectName;

  final M3hdModel lecture;

  const LectureDetAddScreen(
      {super.key, required this.subjectName, required this.lecture, });

  @override
  State<LectureDetAddScreen> createState() => _LectureDetAddScreenState();
}

class _LectureDetAddScreenState extends State<LectureDetAddScreen> {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap:()=>navigatorWid(page: AlertsScreens(alerts: widget.lecture.alerts??"",),context: context,returnPage: true) ,
                  child: Row(
                    children: [
                      Container(
                        height: 50,
                            ...
                            itemBuilder: (context, i) => Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () => navigatorWid(
                                      page: PdfView(
                                          pdfLink: widget.lecture.pdfLinks![i]),
                                      returnPage: true,
                                      context: context),
                                  child: Row(
                                    children: [
