...
class PersonalChatScreen extends StatefulWidget {
  ...
  const PersonalChatScreen({super.key,  required this.chat, required this.user});
          ...
          Container(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.appCuibt.sendChatPersonal(
                          MassageModel(time: Timestamp.now(),massage:textEditingController.text,senderId:  context.appCuibt.user!.token ),
                          widget.chat.chatId
                      );
